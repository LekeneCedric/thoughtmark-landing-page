    ...
    <div className="container">
      ...
      <div className="use-cases-grid">
        ...
        <div className="uc-card">
          <div className="uc-card-head">
            <span className="uc-icon">🤖</span>
            <h3 className="uc-role" data-i18n="uc4Role">Claude Code &amp; Agent Builders</h3>
          </div>
          <ul className="uc-list">
            <li><span className="uc-dash">—</span> <span data-i18n="uc4Item1">Save the plan the AI wrote before you started building</span></li>
            <li><span className="uc-dash">—</span> <span data-i18n="uc4Item2">Bookmark the prompt that generated the component spec</span></li>
            <li><span className="uc-dash">—</span> <span data-i18n="uc4Item3">Mark messages with attached architectures &amp; artifacts</span></li>
            <li><span className="uc-dash">—</span> <span data-i18n="uc4Item4">Long multi-turn agentic threads stay 100% navigable</span></li>
          </ul>
        </div>
